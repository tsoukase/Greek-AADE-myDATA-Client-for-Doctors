...
BRANCHES = {
  'Φλώρινα': ['1',
    'Σαρανταπόρου 28, 53100, Φλώρινα<br />τηλ 2385023513, 6972422931'],
  'Αμύνταιο': ['3',
    'Γεωργίου Παπανδρέου, 53200, Αμύνταιο<br />τηλ 2386024440, 6972422931'],
  'Πτολεμαϊδα': ['4',
    'Βασιλέως Κωνσταντίνου 15, 50200, Πτολεμαϊδα<br />τηλ 2463301783, 6972422931']
  }
